<div class="ol-card">
    <div class="ol-card-body">
        ...
        <div class="table-responsive overflow-auto course_list d-none" id="project_list">
                    ...
                    @foreach ($files as $key => $file)
                        <tr data-id="{{ $file->id }}" class="context-menu">
                            ...
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-12px">{{ $file->user_id }}</h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                                    ...
                                    <div class="dAdmin_profile_name download">
                                        <a href="{{ route(get_current_user_role() . '.file.download', $file->id) }}">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                ...
                                                <path
                                                    d="M7.45 9.92028C7.45 10.2212 7.69905 10.4703 8 10.4703C8.30051 10.4703 8.55 10.2283 8.55 9.92028V1.33362C8.55 1.03267 8.30095 0.783618 8 0.783618C7.69905 0.783618 7.45 1.03267 7.45 1.33362V9.92028Z"
                                                    fill="#6B708A" stroke="#6B708A" stroke-width="0.1" />
                                                <path
            ...
            <button id="delete-selected" class="btn btn-custom-danger d-none"><i
                    class="fi fi-rr-trash"></i>{{ get_phrase('Delete') }}</button>
        </div>
    </div>
</div>
